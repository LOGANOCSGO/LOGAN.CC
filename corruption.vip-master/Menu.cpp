...
#pragma region Aimbot
	...
	AimbotPointscale.SetFileId("aim_pointscale");
	AimbotPointscale.SetBoundaries(0, 5);
...
#pragma region Accuracy
	...
	AccuracyGroup.PlaceLabledControl("Anti-Aim Correction", this, &PitchCorrection);
	...
	AimbotResolver1.SetFileId("acc_aaa");
	AccuracyGroup.PlaceLabledControl("Baim if HP is under", this, &AimbotResolver1);
	...
	FakeLagFix.SetFileId("fakelagfix1");
...
#pragma region AntiAim
	...
	ManualAA1.SetFileId("manualaa1");
	AntiAimGroup.PlaceLabledControl("Manual Side Switch", this, &ManualAA1);

	ManualAA.SetFileId("manualaa");
	AntiAimGroup.PlaceLabledControl("", this, &ManualAA);
	...
	AntiAimGroup.PlaceLabledControl("LBY Angle", this, &BreakLBY);
...
#pragma region Triggerbot
	...
	TriggerGroup.PlaceLabledControl("Legit AA", this, &LegitSpace);
	...
	TriggerGroup.PlaceLabledControl("", this, &LegitChoice);
...
#pragma region Options
	...
	FiltersEnemiesOnly.SetFileId("opt_enemyonly");
	...
	OptionsGroup.PlaceLabledControl("Night Mode", this, &NightMode);
...
#pragma region models
	...
	OtherNoHands1.SetFileId("otr_hands");
...
#pragma region Other
	...
	OtherGroup.PlaceLabledControl("Ranks", this, &OptionsCompRank);
...
#pragma region Effects
	...
	FiltersGroup.PlaceLabledControl("No Flashbang", this, &OtherNoFlash);
	...
	FiltersGroup.PlaceLabledControl("Third Person", this, &OtherThirdperson);
...
#pragma region Other
	...
	OtherViewmodelFOV1.SetFileId("otr_viewfov1");
	OtherGroup.PlaceLabledControl("Viewmodel FOV", this, &OtherViewmodelFOV1);
	OtherViewmodelFOV.SetFileId("otr_viewfov");
	OtherViewmodelFOV.SetBoundaries(0.f, 180.f);
	OtherViewmodelFOV.SetValue(20.f);
...
#pragma region Settings
	...
	OtherClantag.SetFileId("otr_clanspam");
	OtherClantag.AddItem("Off");
	OtherClantag.AddItem("LOGAN.CC");
	...
	FakeLagGroup.PlaceLabledControl("", this, &ConfigSpacing1);

	ConfigSpacing4.SetFileId("otr_astuck1");
	FakeLagGroup.PlaceLabledControl("", this, &ConfigSpacing4);
	...
	FakeLagGroup.PlaceLabledControl("", this, &ConfigBox);
	
	SaveButton.SetFileId("save");
	SaveButton.SetText("Save");
	SaveButton.SetCallback(SaveCallbk);
	FakeLagGroup.PlaceLabledControl("", this, &SaveButton);

	ConfigSpacing2.SetFileId("otr_astuck1");
	FakeLagGroup.PlaceLabledControl("", this, &ConfigSpacing2);

	LoadButton.SetFileId("load");
	LoadButton.SetText("Load");
	LoadButton.SetCallback(LoadCallbk);
	FakeLagGroup.PlaceLabledControl("", this, &LoadButton);

	ConfigSpacing3.SetFileId("otr_astuck1");
	FakeLagGroup.PlaceLabledControl("", this, &ConfigSpacing3);
...
void CSkinchangerTab::Setup()
{
	...
	KnifeGroup.SetSize(246, 100);
	RegisterControl(&KnifeGroup);

	SkinEnable.SetFileId("Skin_enable");
	KnifeGroup.PlaceLabledControl("Enabled", this, &SkinEnable);
	...
	KnifeGroup.PlaceLabledControl("Model", this, &KnifeModel);
	...
	GloveSkin.AddItem("Handwrap - Cobalt Skulls");
	GloveSkin.AddItem("Handwrap - Overprint");
	GloveSkin.AddItem("Handwrap - Duct Tape");
	GloveSkin.AddItem("Handwrap - Arboreal");
	...
	GloveSkin.AddItem("Driver - King Snake");
	GloveSkin.AddItem("Driver - Imperial Plaid");
	GloveSkin.AddItem("Driver - Overtake");
	GloveSkin.AddItem("Driver - Racing Green");
	...
	GloveSkin.AddItem("Sport - Omega");
	GloveSkin.AddItem("Sport - Vice");
	GloveSkin.AddItem("Sport - Amphibious");
	GloveSkin.AddItem("Sport - Bronze Morph");
	...
	GloveSkin.AddItem("Motorcycle - POW!");
	GloveSkin.AddItem("Motorcycle - Turtle");
	GloveSkin.AddItem("Motorcycle - Transport");
	GloveSkin.AddItem("Motorcycle - Polygon");
	...
	GloveSkin.AddItem("Specialist - Fade");
	GloveSkin.AddItem("Specialist - Crimson Web");
	GloveSkin.AddItem("Specialist - Mogul");
	GloveSkin.AddItem("Specialist - Buckshot");
	GloveSkin.AddItem("Hydra - Case Harderned");
	GloveSkin.AddItem("Hydra - Emerald");
	GloveSkin.AddItem("Hydra - Rattler");
	GloveSkin.AddItem("Hydra - Mangrove");
	Gloves.PlaceLabledControl("Skin", this, &GloveSkin);

#pragma region Machineguns
	MachinegunsGroup.SetPosition(279 + 85, 11 + 110);
...
#pragma region Snipers
	Snipergroup.SetPosition(16 + 85, 11 + 110);
...
#pragma region Shotguns
	Shotgungroup.SetPosition(279 + 85, 98 + 110);
...
#pragma region Rifles
	Riflegroup.SetPosition(16 + 85, 213 - 68 + 110);
...
#pragma region MPs
	MPGroup.SetPosition(16 + 85, 423 - 68 + 110);
...
#pragma region Pistols
	PistolGroup.SetPosition(279 + 85, 233 + 110);
	PistolGroup.SetText("Pistols");
	PistolGroup.SetSize(250, 295);
	...
	RevolverSkin.AddItem("Grip");
	RevolverSkin.AddItem("Llama Cannon");
	...
	FIVESEVENSkin.AddItem("Flame Test");
	...
	CZ75Skin.SetFileId("cz_skin");
	CZ75Skin.AddItem("Victoria");
	CZ75Skin.AddItem("Crimson Web");
	CZ75Skin.AddItem("Yellow Jacket");
	CZ75Skin.AddItem("Fuschia");
	CZ75Skin.AddItem("Xiangliu");
	CZ75Skin.AddItem("Pole Position");
	CZ75Skin.AddItem("Tigris");
	CZ75Skin.AddItem("Red Astor");
	CZ75Skin.AddItem("Tread Plate");
	CZ75Skin.AddItem("Chalice");
	CZ75Skin.AddItem("Imprint");
	CZ75Skin.AddItem("Twist");
	CZ75Skin.AddItem("Polymer");
	CZ75Skin.AddItem("Hexane");
	CZ75Skin.AddItem("Tuxedo");
	CZ75Skin.AddItem("Nitro");
	CZ75Skin.AddItem("Emerald");
	CZ75Skin.AddItem("Poison Dart");
	CZ75Skin.AddItem("Tacticat");
	PistolGroup.PlaceLabledControl("CZ75", this, &CZ75Skin);

	SkinApply.SetFileId("apply");
	SkinApply.SetText("Apply");
	SkinApply.SetCallback(KnifeApplyCallbk);
	PistolGroup.PlaceLabledControl("", this, &SkinApply);
