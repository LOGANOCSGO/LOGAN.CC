...
void ClanTag()
{
	...
	case 1:
	{
		...
		switch (value) {
		case 0:SetClanTag(XorStr("               L"), "LOGAN.CC"); break;
		case 1:SetClanTag(XorStr("              LO"), "LOGAN.CC"); break;
		case 2:SetClanTag(XorStr("             LOG"), "LOGAN.CC"); break;
		case 3:SetClanTag(XorStr("            LOGA"), "LOGAN.CC"); break;
		case 4:SetClanTag(XorStr("           LOGAN"), "LOGAN.CC"); break;
		case 5:SetClanTag(XorStr("          LOGAN."), "LOGAN.CC"); break;
		case 6:SetClanTag(XorStr("         LOGAN.C"), "LOGAN.CC"); break;
		case 7:SetClanTag(XorStr("        LOGAN.CC"), "LOGAN.CC"); break;
		case 8:SetClanTag(XorStr("       LOGAN.CC "), "LOGAN.CC"); break;
		case 9:SetClanTag(XorStr("      LOGAN.CC  "), "LOGAN.CC"); break;
		case 10:SetClanTag(XorStr("    LOGAN.CC    "), "LOGAN.CC"); break;
		case 11:SetClanTag(XorStr("   LOGAN.CC     "), "LOGAN.CC"); break;
		case 12:SetClanTag(XorStr("  LOGAN.CC      "), "LOGAN.CC"); break;
		case 13:SetClanTag(XorStr(" LOGAN.CC       "), "LOGAN.CC"); break;
		case 14:SetClanTag(XorStr("LOGAN.CC        "), "LOGAN.CC"); break;
		case 15:SetClanTag(XorStr("OGAN.CC         "), "LOGAN.CC"); break;
		case 16:SetClanTag(XorStr("GAN.CC          "), "LOGAN.CC"); break;
		case 17:SetClanTag(XorStr("AN.CC           "), "LOGAN.CC"); break;
		case 18:SetClanTag(XorStr("N.CC            "), "LOGAN.CC"); break;
		case 19:SetClanTag(XorStr(".CC             "), "LOGAN.CC"); break;
		case 20:SetClanTag(XorStr("CC              "), "LOGAN.CC"); break;
		case 21:SetClanTag(XorStr("C               "), "LOGAN.CC"); break;
		case 22:SetClanTag(XorStr("                "), "LOGAN.CC"); break;
		}
		counter++;
	}
	break;
		...
		else
		{
			if (abc)
			{
				for (MaterialHandle_t i = Interfaces::MaterialSystem->FirstMaterial(); i != Interfaces::MaterialSystem->InvalidMaterial(); i = Interfaces::MaterialSystem->NextMaterial(i))
				{
					...
					if (!strcmp(pMaterial->GetTextureGroupName(), "World textures"))
					{
						pMaterial->ColorModulation(1.f, 1.f, 1.f);
					}
					if (!strcmp(pMaterial->GetTextureGroupName(), "StaticProp textures"))
					{
						pMaterial->ColorModulation(1.f, 1.f, 1.f);
...
{
	if (Menu::Window.SkinchangerTab.EnableGloves.GetState())
	{
		if (!Interfaces::Engine->IsConnected() || !Interfaces::Engine->IsInGame())
			return;
		...
		if (bGlovesNeedUpdate || !pLocal->IsAlive())
		{
			...
			case 7:
			{
				*glovestochange->m_AttributeManager()->m_Item()->ItemDefinitionIndex() = 5035;
				glovestochange->SetModelIndex(Interfaces::ModelInfo->GetModelIndex("models/weapons/v_models/arms/glove_bloodhound/v_glove_bloodhound_hydra.mdl"));
				break;
			}
			default:
				break;
			...
			case 8:
				*glovestochange->FallbackPaintKit() = 10010;
				break;
			case 9:
				*glovestochange->FallbackPaintKit() = 10053;
				break;
			case 10:
				*glovestochange->FallbackPaintKit() = 10054;
				break;
			case 11:
				*glovestochange->FallbackPaintKit() = 10055;
				break;
			case 12:
				*glovestochange->FallbackPaintKit() = 10056;
				break;
			case 13:
			...
			case 16:
				*glovestochange->FallbackPaintKit() = 10015;
				break;
			case 17:
				*glovestochange->FallbackPaintKit() = 10041;
				break;
			case 18:
				*glovestochange->FallbackPaintKit() = 10042;
				break;
			case 19:
				*glovestochange->FallbackPaintKit() = 10043;
				break;
			case 20:
				*glovestochange->FallbackPaintKit() = 10044;
				break;
			case 21:
			...
			case 24:
				*glovestochange->FallbackPaintKit() = 10019;
				break;
			case 25:
				*glovestochange->FallbackPaintKit() = 10047;
				break;
			case 26:
				*glovestochange->FallbackPaintKit() = 10048;
				break;
			case 27:
				*glovestochange->FallbackPaintKit() = 10045;
				break;
			case 28:
				*glovestochange->FallbackPaintKit() = 10046;
				break;
			case 29:
			...
			case 32:
				*glovestochange->FallbackPaintKit() = 10024;
				break;
			case 33:
				*glovestochange->FallbackPaintKit() = 10049;
				break;
			case 34:
				*glovestochange->FallbackPaintKit() = 10050;
				break;
			case 35:
				*glovestochange->FallbackPaintKit() = 10051;
				break;
			case 36:
				*glovestochange->FallbackPaintKit() = 10052;
				break;
			case 37:
			...
			case 40:
				*glovestochange->FallbackPaintKit() = 10030;
				break;
			case 41:
				*glovestochange->FallbackPaintKit() = 10063;
				break;
			case 42:
				*glovestochange->FallbackPaintKit() = 10061;
				break;
			case 43:
				*glovestochange->FallbackPaintKit() = 10064;
				break;
			case 44:
				*glovestochange->FallbackPaintKit() = 10062;
				break;
			case 45:
				*glovestochange->FallbackPaintKit() = 10060;
				break;
			case 46:
				*glovestochange->FallbackPaintKit() = 10057;
				break;
			case 47:
				*glovestochange->FallbackPaintKit() = 10059;
				break;
			case 48:
				*glovestochange->FallbackPaintKit() = 10058;
				break;
			}

			*glovestochange->m_AttributeManager()->m_Item()->ItemIDHigh() = -1;
			*glovestochange->FallbackWear() = 0.0011f;
...
void  __stdcall Hooked_FrameStageNotify(ClientFrameStage_t curStage)
{
	...
	if (Interfaces::Engine->IsConnected() && Interfaces::Engine->IsInGame() && curStage == FRAME_NET_UPDATE_POSTDATAUPDATE_START)
	{
		...
		int CZ75 = Menu::Window.SkinchangerTab.CZ75Skin.GetIndex();
					...
					if (pEntity->GetClientClass()->m_ClassID == (int)CSGOClassID::CKnife)
					{
						if (Model == 0) // Bayonet
						{
							...
							*pWeapon->m_AttributeManager()->m_Item()->ItemDefinitionIndex() = 500;
							...
							{
								*pWeapon->FallbackPaintKit() = 578; // Bright Water
							}
						}
						...
						else if (Model == 8) // M9 Bayonet
						{
							...
							*pWeapon->m_AttributeManager()->m_Item()->ItemDefinitionIndex() = 508;
							...
							{
								*pWeapon->FallbackPaintKit() = 579; // Bright Water
							}
...
void GetViewModelFOV(float& fov)
{
	...
	if (Interfaces::Engine->IsConnected() && Interfaces::Engine->IsInGame())
	{
		...
		if (Menu::Window.VisualsTab.Active.GetState())
		fov += Menu::Window.MiscTab.OtherViewmodelFOV.GetValue();
	}
}
